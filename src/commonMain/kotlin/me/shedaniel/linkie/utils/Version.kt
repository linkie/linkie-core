...
data class Version(val major: Int, val minor: Int, val patch: Int, val snapshot: String? = null) : Comparable<Version> {
    ...
    companion object {
        private val comparator = compareBy<Version> { it.code }.thenBy(nullsLast()) { it.snapshot }
    }

    private val code = versionOf(major, minor, patch)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return this.code == otherVersion.code && this.snapshot == otherVersion.snapshot
    }

    override fun hashCode(): Int = hashCodeOf(code, snapshot)
